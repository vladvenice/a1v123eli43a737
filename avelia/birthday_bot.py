...
BOT_TOKEN  = os.environ["BOT_TOKEN"]        # задаётся в Railway → Variables
CHAT_ID    = int(os.environ["CHAT_ID"])     # задаётся в Railway → Variables
FINAL_LINK = "https://СЮДА_ВСТАВЬ_ССЫЛКУ"  # ← замени на свою ссылку
...
WARMING_MESSAGES = [
    ...
    "🌟 Знаешь, я тут подумал(а)... ты заслуживаешь праздника. И он будет!",
    ...
    "💫 Ты когда-нибудь замечал(а), как перед чем-то классным всегда чуть-чуть тревожно и радостно одновременно?",
    ...
    "🎉 Psst... я знаю один секрет. Он связан с тобой и 6 марта. Вот и всё, что скажу!",
    ...
    "🌺 Знаешь, что мне нравится в тебе? Многое. И 6 марта — отличный повод это сказать!",
